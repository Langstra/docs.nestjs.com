...
For the full and complete documentation please check the [MikroORM website](https://mikro-orm.io/docs/installation). Also if you find any issues please report them on the [MikroORM GitHub](https://github.com/mikro-orm/mikro-orm). 
...
```typescript
$ npm install --save @mikro-orm/core @mikro-orm/nestjs @mikro-orm/mysql       # for mysql/mariadb
```
...
#### Examples
Please checkout the following 2 repositories to see examples on how MikroORM can be used with NestJS.

[MikroORM + NestJS example integration](https://github.com/mikro-orm/nestjs-example-app)


[MikroORM + NestJS realwork example)(https://github.com/mikro-orm/nestjs-realworld-example-app)